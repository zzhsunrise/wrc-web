...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>/css/aboutus.css">
</head>
<body>
<!-- 头部 -->
<div class="top">
    <div class="wrap">
        ...
        <ul class="f-r">
            ...
            <li class="on"><a target="_blank" href="<%=path%>/aboutUs">关于我们</a></li>
...
<div class="content">
    <div class="wrap">
        ...
        <div class="main">
            <img src="<%=basePath%>/images/aboutus/data/data01.jpg" alt="">

            <p>
                “玩儿船网”隶属于风行海商务服务(北京)有限公司，是一家整合全球岛屿旅游资源及提供游艇租赁的私属定制机构。拥有自己专业的团队，自己的帆船队伍，专业的策划团队，给客户定制个性刺激的航海旅行计划。隶属于风行海商务服务(北京)有限公司，是一家整合全球岛屿旅游资源及提供游艇租赁的私属定制机构。拥有自己专业的团队，自己的帆船队伍，专业的策划团队，给客户定制个性刺激的航海旅行计划。隶属于风行海商务服务(北京)有限公司，是一家整合全球岛屿旅游资源及提供游艇租赁的私属定制机构。拥有自己专业的团队，自己的帆船队伍，专业的策划团队，给客户定制个性刺激的航海旅行计划。</p>

            <p>
                隶属于风行海商务服务(北京)有限公司，是一家整合全球岛屿旅游资源及提供游艇租赁的私属定制机构。拥有自己专业的团队，自己的帆船队伍，专业的策划团队，给客户定制个性刺激的航海旅行计划。隶属于风行海商务服务(北京)有限公司，是一家整合全球岛屿旅游资源及提供游艇租赁的私属定制机构。拥有自己专业的团队，自己的帆船队伍，专业的策划团队，给客户定制个性刺激的航海旅行计划。</p>
        </div>
        <div class="connect">
            <div class="us" style="background: #6996e9">联系我们</div>
            <div class="tel">
                <p><span style="background: #f9999a">国内:</span>+86-18653289591</p>

                <p><span style="background: #d897eb">国外:</span>+230 57655895</p>
            </div>
            <p class="address">地址：中国北京市海淀区交大东路66号院1号楼262</p>
        </div>
    </div>
</div>
<!-- content END-->
